...
#define INS_PROVIDE_KCT_TOKEN_INFORMATION 0x0A
...
void menu_settings_details_change(unsigned int enabled) {
  ...
  nvm_write(&N_storage.contractDetails, (void *)&contractDetails,
            sizeof(uint8_t));
  // go back to the menu entry
  UX_MENU_DISPLAY(0, menu_settings, NULL);
}
...
void menu_settings_details_init(unsigned int ignored) {
  UNUSED(ignored);
  UX_MENU_DISPLAY(N_storage.contractDetails ? 1 : 0, menu_settings_details,
                  NULL);
}
...
const bagl_element_t ui_settings_blue[] = {
    ...
    {{BAGL_NONE | BAGL_FLAG_TOUCHABLE, 0x00, 0, 147, 320, 68, 0, 0, BAGL_FILL,
     ...
     0xEEEEEE,
     0x000000,
     ui_settings_blue_toggle_details,
     ui_settings_out_over,
     ui_settings_out_over},
...
const bagl_element_t *ui_approval_blue_1_details(const bagl_element_t *e) {
  if (strlen(ui_approval_blue_values[0]) *
    ...
    ui_details_init(ui_approval_blue_details_name[G_ui_approval_blue_state][0],
...
const bagl_element_t *ui_approval_blue_2_details(const bagl_element_t *e) {
  if (strlen(ui_approval_blue_values[1]) *
      ...
      160) {
    ui_details_init(ui_approval_blue_details_name[G_ui_approval_blue_state][1],
...
const bagl_element_t *ui_approval_blue_3_details(const bagl_element_t *e) {
  if (strlen(ui_approval_blue_values[2]) *
          BAGL_FONT_OPEN_SANS_REGULAR_10_13PX_AVG_WIDTH >=
      160) {
    ui_details_init(ui_approval_blue_details_name[G_ui_approval_blue_state][2],
...
const bagl_element_t ui_approval_blue[] = {
    ...
    {{BAGL_RECTANGLE, 0x90, 30, 314, 260, 1, 1, 0, 0, 0xEEEEEE, COLOR_BG_1, 0,
      0},
     NULL,
     0,
     0,
     ...
     NULL,
     NULL},
    {{BAGL_LABELINE, 0x90, 30, 343, 120, 30, 0, 0, BAGL_FILL, 0x000000,
      COLOR_BG_1, BAGL_FONT_OPEN_SANS_SEMIBOLD_8_11PX, 0},
     "CONTRACT DATA",
     0,
     0,
     ...
     NULL,
     NULL},
    {{BAGL_LABELINE, 0x90, 133, 343, 140, 30, 0, 0, BAGL_FILL, 0x666666,
      COLOR_BG_1,
      BAGL_FONT_OPEN_SANS_REGULAR_10_13PX | BAGL_FONT_ALIGNMENT_RIGHT, 0},
     "Present",
     0,
     ...
     NULL,
     NULL},
    {{BAGL_ICON, 0x90, 278, 333, 12, 12, 0, 0, BAGL_FILL, 0, COLOR_BG_1, 0, 0},
     &C_icon_warning,
     0,
     0,
     0,
...
const bagl_element_t *ui_approval_blue_prepro(const bagl_element_t *element) {
  ...
  if ((element->component.type & (~BAGL_FLAG_TOUCHABLE)) == BAGL_NONE) {
    ...
    case 0x10:
      ...
      if (strlen(ui_approval_blue_values[(element->component.userid & 0xF)]) *
              BAGL_FONT_OPEN_SANS_LIGHT_16_22PX_AVG_WIDTH >=
          160) {
...
unsigned int ui_data_selector_blue_button(unsigned int button_mask,
                                          unsigned int button_mask_counter) {
  return 0;
}
#endif // #if defined(TARGET_BLUE)
...
const bagl_element_t ui_data_parameter_blue[] = {
    ...
    {{BAGL_LABELINE, 0x00, 30, 136, 260, 30, 0, 0, BAGL_FILL, 0x000000,
      COLOR_BG_1, BAGL_FONT_OPEN_SANS_REGULAR_10_13PX, 0},
     strings.tmp.tmp2,
     0,
     0,
     ...
     NULL,
     NULL},
    {{BAGL_LABELINE, 0x10, 30, 159, 260, 30, 0, 0, BAGL_FILL, 0x000000,
      COLOR_BG_1, BAGL_FONT_OPEN_SANS_REGULAR_10_13PX, 0},
     addressSummary,
     0,
     0,
     ...
     NULL,
     NULL},
    {{BAGL_LABELINE, 0x11, 30, 182, 260, 30, 0, 0, BAGL_FILL, 0x000000,
      COLOR_BG_1, BAGL_FONT_OPEN_SANS_REGULAR_10_13PX, 0},
     addressSummary,
     0,
     0,
     ...
     NULL,
     NULL},
    {{BAGL_LABELINE, 0x12, 30, 205, 260, 30, 0, 0, BAGL_FILL, 0x000000,
      COLOR_BG_1, BAGL_FONT_OPEN_SANS_REGULAR_10_13PX, 0},
     addressSummary,
     0,
     0,
     ...
     NULL,
     NULL},
    {{BAGL_LABELINE, 0x13, 30, 228, 260, 30, 0, 0, BAGL_FILL, 0x000000,
      COLOR_BG_1, BAGL_FONT_OPEN_SANS_REGULAR_10_13PX, 0},
     addressSummary,
     0,
     0,
...
unsigned int ui_data_parameter_blue_button(unsigned int button_mask,
                                           unsigned int button_mask_counter) {
  return 0;
}
#endif // #if defined(TARGET_BLUE)
...
//////////////////////////////////////////////////////////////////////
UX_FLOW_DEF_NOCB(ux_idle_flow_1_step,
                 nn, // pnn,
                 {
                     //"", //&C_icon_dashboard,
                     "Application",
...
UX_FLOW_DEF_NOCB(ux_idle_flow_2_step, bn,
                 {
                     "Version",
                     APPVERSION,
                 });
UX_FLOW_DEF_VALID(ux_idle_flow_3_step, pb, display_settings(),
                  {
                      &C_icon_eye,
                      "Settings",
                  });
UX_FLOW_DEF_VALID(ux_idle_flow_4_step, pb, os_sched_exit(-1),
                  {
                      &C_icon_dashboard_x,
                      "Quit",
                  });
const ux_flow_step_t *const ux_idle_flow[] = {
    &ux_idle_flow_1_step, &ux_idle_flow_2_step, &ux_idle_flow_3_step,
    &ux_idle_flow_4_step, FLOW_END_STEP,
};

#if defined(TARGET_NANOS)

UX_FLOW_DEF_VALID(ux_settings_flow_1_step, bnnn_paging,
...
UX_FLOW_DEF_VALID(ux_settings_flow_2_step, bnnn_paging,
...
UX_FLOW_DEF_VALID(ux_settings_flow_1_step, bnnn,
                  switch_settings_contract_data(),
                  {
                      "Contract data",
                      "Allow contract data",
...
UX_FLOW_DEF_VALID(ux_settings_flow_2_step, bnnn, switch_settings_display_data(),
                  {"Debug data", "Display contract data", "details",
                   strings.common.fullAddress + 20});

#endif

UX_FLOW_DEF_VALID(ux_settings_flow_3_step, pb, ui_idle(),
                  {
                      &C_icon_back_x,
                      "Back",
                  });
...
void display_settings() {
  strcpy(strings.common.fullAddress,
...
//////////////////////////////////////////////////////////////////////
UX_FLOW_DEF_NOCB(ux_display_public_flow_1_step, pnn,
                 {
                     &C_icon_eye,
                     "Verify",
                     "address",
                 });
UX_FLOW_DEF_NOCB(ux_display_public_flow_2_step, bnnn_paging,
                 {
                     .title = "Address",
                     .text = strings.common.fullAddress,
                 });
UX_FLOW_DEF_VALID(ux_display_public_flow_3_step, pb,
                  io_seproxyhal_touch_address_ok(NULL),
                  {
                      &C_icon_validate_14,
                      "Approve",
                  });
UX_FLOW_DEF_VALID(ux_display_public_flow_4_step, pb,
...
//////////////////////////////////////////////////////////////////////
UX_FLOW_DEF_NOCB(ux_confirm_selector_flow_1_step, pnn,
                 {
                     &C_icon_eye,
                     "Verify",
                     "selector",
...
UX_FLOW_DEF_NOCB(ux_confirm_selector_flow_2_step, bn,
                 {"Selector", strings.tmp.tmp});
UX_FLOW_DEF_VALID(ux_confirm_selector_flow_3_step, pb,
                  io_seproxyhal_touch_data_ok(NULL),
                  {
                      &C_icon_validate_14,
                      "Approve",
                  });
UX_FLOW_DEF_VALID(ux_confirm_selector_flow_4_step, pb,
...
//////////////////////////////////////////////////////////////////////
UX_FLOW_DEF_NOCB(ux_confirm_parameter_flow_1_step, pnn,
                 {&C_icon_eye, "Verify", strings.tmp.tmp2});
UX_FLOW_DEF_NOCB(ux_confirm_parameter_flow_2_step, bnnn_paging,
                 {
                     .title = "Parameter",
                     .text = strings.tmp.tmp,
                 });
UX_FLOW_DEF_VALID(ux_confirm_parameter_flow_3_step, pb,
                  io_seproxyhal_touch_data_ok(NULL),
                  {
                      &C_icon_validate_14,
                      "Approve",
                  });
UX_FLOW_DEF_VALID(ux_confirm_parameter_flow_4_step, pb,
                  io_seproxyhal_touch_data_cancel(NULL),
                  {
                      &C_icon_crossmark,
                      "Reject",
...
//////////////////////////////////////////////////////////////////////
UX_FLOW_DEF_NOCB(ux_approval_tx_1_step, pnn,
                 {
                     &C_icon_eye,
                     "Review",
                     "transaction",
                 });
UX_FLOW_DEF_NOCB(ux_approval_tx_2_step, bnnn_paging,
                 {.title = "Amount", .text = strings.common.fullAmount});
UX_FLOW_DEF_NOCB(ux_approval_tx_3_step, bnnn_paging,
                 {
                     .title = "Address",
                     .text = strings.common.fullAddress,
                 });
UX_FLOW_DEF_NOCB(ux_approval_tx_4_step, bnnn_paging,
                 {
                     .title = "Max Fees",
                     .text = strings.common.maxFee,
                 });
UX_FLOW_DEF_VALID(ux_approval_tx_5_step, pbb, io_seproxyhal_touch_tx_ok(NULL),
                  {
                      &C_icon_validate_14,
                      "Accept",
                      "and send",
                  });
UX_FLOW_DEF_VALID(ux_approval_tx_6_step, pb,
...
UX_FLOW_DEF_NOCB(ux_approval_tx_data_warning_step, pbb,
                 {
                     &C_icon_warning,
                     "Data",
                     "Present",
...
const ux_flow_step_t *const ux_approval_tx_flow[] = {
    &ux_approval_tx_1_step, &ux_approval_tx_2_step, &ux_approval_tx_3_step,
    &ux_approval_tx_4_step, &ux_approval_tx_5_step, &ux_approval_tx_6_step,
    FLOW_END_STEP,
};

const ux_flow_step_t *const ux_approval_tx_data_warning_flow[] = {
    &ux_approval_tx_1_step, &ux_approval_tx_data_warning_step,
    &ux_approval_tx_2_step, &ux_approval_tx_3_step,
    &ux_approval_tx_4_step, &ux_approval_tx_5_step,
    &ux_approval_tx_6_step, FLOW_END_STEP,
};

//////////////////////////////////////////////////////////////////////
UX_FLOW_DEF_NOCB(ux_sign_flow_1_step, pnn,
                 {
                     &C_icon_certificate,
                     "Sign",
                     "message",
                 });
UX_FLOW_DEF_NOCB(ux_sign_flow_2_step, bnnn_paging,
                 {
                     .title = "Message hash",
                     .text = strings.common.fullAddress,
                 });
UX_FLOW_DEF_VALID(ux_sign_flow_3_step, pbb,
...
UX_FLOW_DEF_VALID(ux_sign_flow_4_step, pbb,
...
const ux_flow_step_t *const ux_sign_flow[] = {
    &ux_sign_flow_1_step, &ux_sign_flow_2_step, &ux_sign_flow_3_step,
...
void format_signature_out(const uint8_t *signature) {
  ...
  memmove(G_io_apdu_buffer + offset + 32 - xlength, signature + xoffset,
          xlength);
  offset += 32;
...
unsigned int io_seproxyhal_touch_tx_ok(const bagl_element_t *e) {
  ...
  signatureLength = cx_ecdsa_sign(&privateKey, CX_RND_RFC6979 | CX_LAST,
                                  CX_SHA256, tmpCtx.transactionContext.hash,
...
unsigned int io_seproxyhal_touch_signMessage_ok(const bagl_element_t *e) {
  ...
  io_seproxyhal_io_heartbeat();
  signatureLength = cx_ecdsa_sign(&privateKey, CX_RND_RFC6979 | CX_LAST,
                                  CX_SHA256, tmpCtx.messageSigningContext.hash,
...
tokenDefinition_t *getKnownToken() {
  ...
  case CHAIN_KIND_KLAYTN:
    numTokens = NUM_TOKENS_KLAYTN;
    break;
  case CHAIN_KIND_KLAYTN_TESTNET:
    numTokens = NUM_TOKENS_KLAYTN_TESTNET;
    break;
  }
  for (i = 0; i < numTokens; i++) {
    switch (chainConfig->kind) {
    case CHAIN_KIND_KLAYTN:
      currentToken = (tokenDefinition_t *)PIC(&TOKENS_KLAYTN[i]);
      break;
    case CHAIN_KIND_KLAYTN_TESTNET:
      currentToken = (tokenDefinition_t *)PIC(&TOKENS_KLAYTN_TESTNET[i]);
      break;
    }
    if (os_memcmp(currentToken->address, tmpContent.txContent.destination,
                  20) == 0) {
      return currentToken;
    }
  }
  ...
  if ((currentTokenSet || tokenProvisioned) &&
      (os_memcmp(tmpCtx.transactionContext.currentToken.address,
...
customStatus_e customProcessor(txContext_t *context) {
  if ((context->currentField == TX_RLP_DATA) &&
    ...
    if (context->currentFieldPos == 0) {
      // If handling the beginning of the data field, assume that the function
      // selector is present
    ...
    if (tokenProvisioned) {
      ...
      copySize = (context->commandLength < blockSize ? context->commandLength
                                                     : blockSize);
      copyTxData(context,
                 dataContext.rawDataContext.data +
                     dataContext.rawDataContext.fieldOffset,
                 copySize);
      ...
      if (copySize == blockSize) {
        ...
        if (fieldPos == 0) {
          ...
          uint32_t offset = 0;
          uint32_t i;
          snprintf(strings.tmp.tmp2, sizeof(strings.tmp.tmp2), "Field %d",
                   dataContext.rawDataContext.fieldIndex);
          for (i = 0; i < 4; i++) {
...
void handleGetPublicKey(uint8_t p1, uint8_t p2, uint8_t *dataBuffer,
  ...
  io_seproxyhal_io_heartbeat();
  os_perso_derive_node_bip32(
      CX_CURVE_256K1, bip32Path, bip32PathLength, privateKeyData,
  ...
  os_memset(privateKeyData, 0, sizeof(privateKeyData));
  io_seproxyhal_io_heartbeat();
  getKlayAddressStringFromKey(&tmpCtx.publicKeyContext.publicKey,
...
tmpCtx.publicKeyContext.address, 4); os_memmove((unsigned char *)(addressSummary
+ 6), "...", 3); os_memmove((unsigned char *)(addressSummary + 9),
tmpCtx.publicKeyContext.address + 40 - 4, 4); addressSummary[13] = '\0';
*/

    // prepare for a UI based reply
#if defined(TARGET_BLUE)
    snprintf(strings.common.fullAddress, sizeof(strings.common.fullAddress),
             "0x%.*s", 40, tmpCtx.publicKeyContext.address);
...
void finalizeParsing(bool direct) {
  ...
  // Add address
  if (tmpContent.txContent.destinationLength != 0) {
    getKlayAddressStringFromBinary(tmpContent.txContent.destination, address,
                                   &sha3);
    /*
addressSummary[0] = '0';
addressSummary[1] = 'x';
...
*/
  ...
  adjustDecimals((char *)(G_io_apdu_buffer + 100), i, (char *)G_io_apdu_buffer,
                 100, decimals);
  i = 0;
  tickerOffset = 0;
...
#elif defined(HAVE_UX_FLOW)
  ux_flow_init(0,
               ((dataPresent && !N_storage.contractDetails)
                    ? ux_approval_tx_data_warning_flow
                    : ux_approval_tx_flow),
               NULL);
#elif defined(TARGET_NANOS)
  ux_step = 0;
...
void handleProvideKctTokenInformation(uint8_t p1, uint8_t p2,
                                      uint8_t *workBuffer, uint16_t dataLength,
  ...
  dataLength--;
  if ((tickerLength + 1) >=
      sizeof(tmpCtx.transactionContext.currentToken.ticker)) {
    THROW(0x6A80);
  }
  ...
  os_memmove(tmpCtx.transactionContext.currentToken.ticker, workBuffer + offset,
             tickerLength);
  ...
  os_memmove(tmpCtx.transactionContext.currentToken.address,
             workBuffer + offset, 20);
  offset += 20;
  dataLength -= 20;
  ...
  offset += 4;
  dataLength -= 4;
  cx_ecfp_init_public_key(CX_CURVE_256K1, TOKEN_SIGNATURE_PUBLIC_KEY,
                          sizeof(TOKEN_SIGNATURE_PUBLIC_KEY), &tokenKey);
  if (!cx_ecdsa_verify(&tokenKey, CX_LAST, CX_SHA256, hash, 32,
                       workBuffer + offset, dataLength)) {
...
void handleSignPersonalMessage(uint8_t p1, uint8_t p2, uint8_t *workBuffer,
  ...
  if (p1 == P1_FIRST) {
    ...
    cx_hash((cx_hash_t *)&sha3, 0, (uint8_t *)SIGN_MAGIC,
            sizeof(SIGN_MAGIC) - 1, NULL, 0);
    for (index = 1;
         (((index * base) <= tmpCtx.messageSigningContext.remainingLength) &&
          (((index * base) / base) == index));
         index *= base)
      ;
    for (; index; index /= base) {
      tmp[pos++] =
          '0' + ((tmpCtx.messageSigningContext.remainingLength / index) % base);
    }
    tmp[pos] = '\0';
  ...
  if (tmpCtx.messageSigningContext.remainingLength == 0) {
    cx_hash((cx_hash_t *)&sha3, CX_LAST, workBuffer, 0,
            tmpCtx.messageSigningContext.hash, 32);
...
void handleApdu(volatile unsigned int *flags, volatile unsigned int *tx) {
  ...
  BEGIN_TRY {
    TRY {
      ...
      case INS_PROVIDE_KCT_TOKEN_INFORMATION:
        currentTokenSet = false;
        handleProvideKctTokenInformation(
