  ...
  BEGIN_TRY {
    TRY {
      ...
      switch (G_io_apdu_buffer[OFFSET_INS]) {
        ...
        case INS_PROVIDE_TOKEN_INFORMATION:
          handleProvideTokenInformation(G_io_apdu_buffer[OFFSET_P1], G_io_apdu_buffer[OFFSET_P2], G_io_apdu_buffer + OFFSET_CDATA, G_io_apdu_buffer[OFFSET_LC], flags, tx);
          break;
...
__attribute__((section(".boot"))) int main(int arg0) {
    ...
    BEGIN_TRY {
        TRY {
            ...
            // delegate to Klaytn app/lib
            libcall_params[0] = "Klaytn";
