...
#define INS_PROVIDE_TOKEN_INFORMATION 0x0A
...
void handleProvideTokenInformation(uint8_t p1, uint8_t p2, uint8_t *dataBuffer, uint16_t dataLength, unsigned int *flags, unsigned int *tx);
